...
const ChangeHeadFamilySection = ({ form }: { form: FormInstance<any> }) => {
  return (
    <>
      <Form.Item
        name="old_family_card_url"
        label={<CusttomInputLabel>Kartu Keluarga Lama </CusttomInputLabel>}
        rules={[{ required: true, message: 'Kartu Keluarga Lama diperlukan!' }]}
      >
        <CloudUpload
          name="old_family_card_url"
          form={form}
...
export default ChangeHeadFamilySection;
