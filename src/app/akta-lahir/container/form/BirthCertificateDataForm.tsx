...
import { Button, Form, type FormInstance, Input, Upload } from 'antd';
    ...
    <Form form={form} layout="vertical">
      <div className="flex flex-col items-center gap-0 md:flex-row md:gap-4">
        <div className="w-full basis-1/2">
          ...
          >
            <CloudUpload name="father_identity_card_url" form={form} />
        ...
        <div className="w-full basis-1/2 gap-4">
          ...
          >
            <CloudUpload name="mother_identity_card_url" form={form} />
          </Form.Item>
          ...
          >
            <CloudUpload name="witness_identity_card_url" form={form} />
          </Form.Item>
        </div>
        <div className="w-full basis-1/2">
          <Form.Item
        ...
        <div className="w-full basis-1/2 gap-4">
          ...
          >
            <CloudUpload name="out_of_wedlock_image_url" form={form} />
            <p className="mt-2 text-xs font-medium">
